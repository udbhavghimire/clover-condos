...
<head>
    ...
    <meta name="description"
        content="Clover Condos by Truman in Calgary, offering 415 units across four buildings in Carrington and 420 units in North West Calgary. Strategically located with future LRT line frontage, it promises optimal connectivity. Launching in Q2 2024 with a two-year rental guarantee and waived condo fees, experience affordability and luxury.">
    <meta name="keywords"
        content="Clover Condos, Clover Condos Calgary, Condos in Calgary, Condos in Calgary from 400's, Truman Homes">
...
<body>
                      ...
                      Condos
                                ...
                                <div class="pt-2 pt-sm-2 pt-md-4 rounded-mine mt-4 ">
                                    ...
                                    <p class="headline-textt headline-textt-sm">
                                        Clover Condos by Truman in Calgary, offering 415 units across four buildings in
                                        Carrington and 420 units in North West Calgary. Strategically located with
                                        future LRT line frontage, it promises optimal connectivity. Launching in Q2 2024
                                        with a two-year rental guarantee and waived condo fees, experience affordability
                                        and luxury.
        ...
        <section>
            <div class="container" id="gallery">
                ...
                <div class="pt-md-5 pt-5">
                    ...
                    <span class="small-text text-center d-flex justify-content-center custom-underline pb-3">Discover
                        beautiful inside and out</span>
                    <div>
                        <section>
                            <div class="rounded-3">
                                <div class="d-flex justify-content-between pb-3">
                                    <div
                                        ...
                                        <div class="col">
                                            <div class="afte">
                                                <img loading="lazy" src="images/Clover-Condos 2.jpeg"
                                                    alt="Clover Condos" class="img-fluid imghei">
                                            </div>
                                        </div>
                                        <div class="col">
    ...
    <div class="py-md-5 pt-5 container" id="plans">
        ...
        <ul class="nav nav-pills  d-flex justify-content-center" id="pills-tab" role="tablist">
            <li class="nav-item me-2 me-md-3 my-2" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-1bd"
                    type="button" role="tab" aria-controls="pills-home" aria-selected="true">2 BEDS</button>
            </li>
            <li class="nav-item me-2 me-md-3 my-2" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-1bdden"
                    type="button" role="tab" aria-controls="pills-profile" aria-selected="false">3 BEDS </button>
            </li>
        </ul>
        <div class="my-5"></div>
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-1bd" role="tabpanel" aria-labelledby="pills-home-tab">
                <div
                    ...
                    <div class="col floorbtns">
                        <div class="card border-0 shadow-lg rounded-mine">
                            <img loading="lazy" src="plans/2bed2.png" class="card-img-top rounded-top-mine"
                                alt="Clover 2 bed | 1 bath">
                            <div class="card-body">
            ...
            <div class="tab-pane fade" id="pills-1bdden" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div
                    ...
                    <div class="col floorbtns">
                        <div class="card border-0 shadow-lg rounded-mine">
                            <img loading="lazy" src="plans/3bed2.png" class="card-img-top rounded-top-mine"
                                alt="Clover 3 bed | 2 bath">
                            <div class="card-body">
    ...
    <section>
        <div class="container pt-md-2">
            ...
            <div class="py-5" id="location">
                ...
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3">14121 Center
                    Street N.W. – Calgary, Alberta</span>
                <div class="row row-cols-md-2 row-cols-1">
                    ...
                    <div class="bg-white p-1   rounded-mine d-flex justify-content-center align-items-center col">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2501.186859914325!2d-114.0830572!3d51.178778799999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5371671acbb11a99%3A0xf84ecf9103bfd43f!2sCarrington%20Blvd%2C%20Calgary%2C%20AB%2C%20Canada!5e0!3m2!1sen!2snp!4v1710595491641!5m2!1sen!2snp"
                            width="90%" height="620" style="border:0;" allowfullscreen="" loading="lazy"
    ...
    <section id="builder">
        ...
        <div class="pt-5">
            <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center brand-color">
                <span class="mx-1">About Truman Homes </span>
            </h2>
            ...
            <span
                ...
                to Quality A Legacy of Acknowledgment Truman's remarkable expertise in constructing homes has not
                escaped recognition.</span>
        </div>
    </section>

    <div class="floating fixcontact"><a href="#Contact" class="btn bgggggggg br-m text-dark w-100 py-2 shadow-lg d-md-none d-block">Register Now
                        ...
                        <form action="./contactForm.php" method="POST">
                            ...
                            <div class="row ">
                                <p class=" text-muted sm-text text-center mt-0 ">*I consent to receive future
                                    communications about Clover Condos. I understand I can opt out at anytime by sending
                                    an email.</p>
                            </div>
                            <div class="row ">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 justify-content-between ">
                <div class="col-md-5 my-3 fotwidth center-sm px-4 px-md-0">
                    ...
                    <div class="list pt-2 d-md-block d-none">
                        <p class=""> <a href="https://dolphy.ca/pre-construction-homes/calgary" target="_blank"
            ...
            <div class="list mt-5 pt-5 d-md-none d-block center-sm">
                <p class="">
                    <a href="https://dolphy.ca/pre-construction-homes/calgary" target="_blank"
                        class="text-dark text-decoration-none"> <strong>Check out all calgary pre construction homes
                            projects on Dolphy.</strong></a>
                </p>
